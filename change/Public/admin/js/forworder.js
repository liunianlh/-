$(function(){
	...
	autoCheck();
	$("#company,#receiver,#phone,#email,#city,#dist,#address,#shipment").bind('input propertychange',function(e){
		autoCheck();
	});
	function autoCheck(){
		var reg=/\s+/;
	...
	$(document).on("click",".editA",function(){
		...
		$.ajax({
			...
			success:function(res){
				var info=res.msg;
				company=$("#company").val(info.for_company_name);
				receiver=$("#receiver").val(info.for_receiver);
				phone=$("#phone").val(info.for_receiver_phone);
				email=$("#email").val(info.for_receiver_email);
				...
				address=$("#address").val(info.for_address);
				shipment=$("#shipment").val(info.shipment_id);
